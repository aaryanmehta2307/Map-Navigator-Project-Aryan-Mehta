...
export default class PathfindingVisualizer extends Component {
    ...
    handleMouseEnter(row, col) {
        if (!this.state.mouseIsPressed || this.state.clickCount < 2 || this.state.visualizationComplete) return;
        const newGrid = getNewGridWithWallToggled(this.state.grid, row, col);
    ...
    render() {
        const { grid, mouseIsPressed, visualizationComplete, showPopup } = this.state;
        return (
            <>
